I coded a mobile application that lists music by pulling data from a json file. You can see all the information about the music. You can also search for music.
